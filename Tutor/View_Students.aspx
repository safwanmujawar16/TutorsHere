<%@ Page Title="" Language="C#" MasterPageFile="~/Tutor/tutor_dashboard.Master" AutoEventWireup="true" CodeBehind="View_Students.aspx.cs" Inherits="TutorsHere.Tutor.View_Students" %>
            ...
            <ItemTemplate>
                <div class="col-md-4 ">
                    <div class="card bg-dark text-white text-center">
                        ...
                        <h5>
                            <asp:Label ID="Label9" runat="server" Text='<%#Bind("tutiontype")%>'></asp:Label>
                        </h5>
